...
- **트리거:** 매월 26일경
- **담당(실행):** 가재(자동화) + 이병덕 대표
- **확인(승인):** 담당 차장 — **정지혜 차장**(jj@kspeaks.kr) *(잠정, 확인 필요)*
  - 방희영 차장 출산휴가 중
...
### 4) 담당 차장 확인
- 대상: **정지혜 차장** *(확정 필요)*
- 방식: **이메일 또는 Slack DM** *(확정 필요 — 전자결재(GDriveFlow)는 자동 처리 불가, 대표가 직접 상신)*
...
## 미확정 항목 (TODO)
- [ ] 담당 차장이 정지혜 차장이 맞는지 확정
- [ ] 4단계 확인 방식: 이메일 / Slack / 전자결재 중 택1
- [ ] 5월 메일의 "신은재 종합소득세 묶어서 청구" 문구를 매월 넣을지
- [ ] 세무사 메일에 첨부파일(4대보험 청구내역) 필요 여부
